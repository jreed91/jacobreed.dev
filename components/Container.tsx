...
export default function Container(props: any) {
  ...
  const meta = {
    ...
    image: 'https://jacobreed.dev/static/images/banner.png',
    type: 'website',
    ...customMeta
  };
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      <Head>
        ...
        <meta property="og:url" content={`https://jacobreed.dev${router.asPath}`} />
        <link rel="canonical" href={`https://jacobreed.dev${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Jacob Reed" />
      ...
      <div className="flex flex-col justify-center px-8">
        <nav className="flex items-center justify-between w-full relative max-w-4xl border-gray-200 dark:border-gray-700 mx-auto pt-8 pb-8 sm:pb-16  text-gray-900 bg-gray-50  dark:bg-gray-900 bg-opacity-60 dark:text-gray-100">
          ...
          <button
            ...
            type="button"
            className="w-9 h-9 bg-gray-200 rounded-lg dark:bg-gray-600 flex items-center justify-center  hover:ring-2 ring-gray-300  transition-all sm:hidden"
            onClick={() =>
