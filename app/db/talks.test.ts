...
describe("getYouTubeEmbedUrl", () => {
  ...
  it("allows root-relative paths by correctly parsing them as having http protocol against the localhost base", () => {
    expect(getYouTubeEmbedUrl("/videos/my-talk.mp4")).toBe(
      "/videos/my-talk.mp4",
    );
  });
});
